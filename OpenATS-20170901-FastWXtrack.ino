...
所有程序和代码，已经分享到我的百度网盘，地址：https://pan.baidu.com/s/1slbU0f7
...
//程序自动追踪代码结束
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  else if(usbdata.startsWith("W") && power != 1 && power_tmp != -1)                                 //检测是否为天线唤醒命令“W”
  {     
   ...
   else if(usbdata.startsWith("U") && power == -1 && power_tmp == -1)                                 //检测是否为天线锁定命令“L”
  {     
      Serial.println("Antenna is UNLOCKED, Now please wait 2 senconds !!");
      Serial.println("--------------------------------------------------"); 
      digitalWrite(power1Pin, HIGH);
      digitalWrite(power2Pin, HIGH);
      power = 1; 
